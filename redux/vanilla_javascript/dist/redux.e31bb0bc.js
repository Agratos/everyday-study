...
var btnDecrease = document.querySelector('#decrease'); // 액션 이름은 문자열 형태로 주로 대문자로 작성하며 액션이름은 고유해야 합니다.

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션 이름을 사용하여 액션 객체를 만드는 액션 생성 함수를 작성
...
var increase = function increase(number) {
  return {
    type: INCREASE,
    number: number
  };
...
render();
store.subscribe(render); //디스패치를 할 때는 스토어의 내장 함수 dispatch를 사용합니다.
